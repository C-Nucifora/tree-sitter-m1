...
enum ts_symbol_identifiers {
  ...
  sym__is_pattern = 76,
  sym_negative_number = 77,
  sym_expand_statement = 78,
  sym__expression = 79,
  ...
  aux_sym_when_statement_repeat1 = 89,
  aux_sym_is_pattern_list_repeat1 = 90,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [108] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(53),
  ...
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_negative_number, 2, 0, 0),
  [192] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__expression, 1, 0, 0), REDUCE(sym_negative_number, 2, 0, 0),
  ...
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_local_declaration, 5, 0, 11),
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_empty_statement, 1, 0, 0),
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_local_declaration, 5, 0, 10),
  [226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_local_declaration, 3, 0, 3),
  ...
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_local_declaration, 6, 0, 14),
  [236] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_local_declaration, 4, 0, 6),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_local_declaration, 6, 0, 15),
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 6, 0, 12),
  [242] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_local_declaration, 7, 0, 17),
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_when_statement, 7, 0, 16),
  [246] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment_statement, 4, 0, 9),
  [248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_else_clause, 2, 0, 0),
  ...
  [334] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_is_pattern_list_repeat1, 2, 0, 22), SHIFT_REPEAT(51),
